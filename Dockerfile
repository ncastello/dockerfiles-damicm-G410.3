...
RUN mkdir -p /opt/geant4.10 \
    && cd /opt/geant4.10 \
    && wget http://github.com/Geant4/geant4/archive/v10.3.1.tar.gz \
    && tar -xzf v10.3.1.tar.gz && rm v10.3.1.tar.gz \
    && mkdir /opt/geant4-10-build && cd /opt/geant4-10-build \
    && cmake /opt/geant4.10/geant4-10.3.1 \
...
WORKDIR /home/damicmuser/G4103Sim

#
USER damicmuser

ENV HOME /home/damicmuser
ENV DAMICM_SIM_ROOT /G4103Sim/DamicG4
